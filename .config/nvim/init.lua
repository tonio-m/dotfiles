...
vim.keymap.set('n', '<leader>x', ':execute "silent! bwipeout!"<CR>', { noremap = true, silent = false })
vim.keymap.set('n', '<leader>xa', ':execute "silent! bwipeout!"<CR>', { noremap = true, silent = false })
vim.keymap.set('n', '<leader>w', ':w<CR>', { noremap = true, silent = false })

vim.keymap.set('n', '<leader>dd', ':D<CR>', { noremap = true, silent = false })
...
vim.keymap.set('n', '<leader>dn', ':Dn<CR>', { noremap = true, silent = false })
vim.keymap.set('n', '<leader>dp', ':Dp<CR>', { noremap = true, silent = false })
vim.keymap.set('n', '<leader>in', ':In<CR>', { noremap = true, silent = false })
vim.keymap.set('n', '<leader>id', deque_inbox, { noremap = true, silent = false})
vim.keymap.set('n', '<leader>jo', ':Jo<CR>', { noremap = true, silent = false })
vim.keymap.set('n', '<leader>nn', ':Nn<CR>', { noremap = true, silent = false })
vim.keymap.set('n', '<leader>sn', ':Sn<CR>', { noremap = true, silent = false })
vim.keymap.set('n', '<leader>va', ':Va<CR>', { noremap = true, silent = false })
...
vim.keymap.set('n', '<leader>df', ':Df<CR>', { noremap = true, silent = false })
vim.keymap.set('n', '<leader>rf', ':Rf<CR>', { noremap = true, silent = false })
...
vim.keymap.set('n', 'gF', ':vsp | edit <cfile><CR>', {noremap = true, silent = false})
